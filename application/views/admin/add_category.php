...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <h3 class="page-title">
        <?php echo $this->lang->line("add"); ?> <?php echo $this->lang->line("category"); ?> <small><?php echo $this->lang->line("add"); ?> <?php echo $this->lang->line("category"); ?></small>
    </h3>
    <ul class="breadcrumb">
        <li>
            <i class="icon-home"></i>
        ...
        <li>
            <a href="#"><?php echo $this->lang->line("category"); ?></a>
            <i class="icon-angle-right"></i>
        </li>
        <li><a href="<?php site_url('category'); ?>"><?php echo $this->lang->line("add"); ?> <?php echo $this->lang->line("category"); ?></a></li>
    </ul>
    ...
    <div class="span12">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption"><i class="icon-asterisk"></i><?php echo $this->lang->line("add"); ?> <?php echo $this->lang->line("category"); ?></div>
                <div class="tools">
