...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <h3 class="page-title">
        <?php echo $this->lang->line("show")." ".$this->lang->line("products");?> <small><?php echo $this->lang->line("show")." ".$this->lang->line("all")." ".$this->lang->line("products");?></small>
    </h3>
    <ul class="breadcrumb">
        <li>
            <i class="icon-home"></i>
        ...
        <li><a href="<?php site_url('products/listing'); ?>"><?php echo $this->lang->line("show"); ?> <?php echo $this->lang->line("products"); ?></a></li>
    </ul>
    ...
    <div class="span12">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption"><i class="icon-asterisk"></i><?php echo $this->lang->line("show"); ?> <?php echo $this->lang->line("products"); ?></div>
                <div class="tools">
                        ...
                        if (isset($product_list)) {
                            foreach ($product_list as $product) {
                                ...
                                <tr >
                                    ...
                                    <td><img src = "<?php echo base_url() . 'images/products/thumb' . $product->image; ?>" ></td>
                                    
                                    <td style="width:70px;">
                                        <a href="<?php echo base_url('products/manageProducts'); ?>/<?php echo $product->id; ?>" ><img src = "<?php echo base_url() . 'images/edit.png' ?>" alt="Edit" height="30" width="30"></a>
                                        <a href="<?php echo base_url('common/isDeleted'); ?>/<?php echo $product->id; ?>" ><img src = "<?php echo base_url() . 'images/delete.png' ?>" alt="Delete" height="30" width="30"></a>
                                    </td>
