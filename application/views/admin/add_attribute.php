        ...
        <div class="portlet box green">
            ...
            <div class="portlet-body form">
                ...
                <div class="control-group">
                    <label class="control-label"><?php echo $this->lang->line("category"); ?> <span class="required">*</span></label>
                    <div class="controls">
                        <select name="category" class="span6 m-wrap" >
                        	<option value="0" seleted><?php echo $this->lang->line("category"); ?> </option>
                            <?php
                ...
                <div class="control-group attr">
                    ...
                    <div class="controls">
                        <select name="attribute_name[]" class="chosen span6 m-wrap" multiple>
