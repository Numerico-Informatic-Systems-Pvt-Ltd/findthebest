...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <h3 class="page-title">
        Show category <small>Show all category</small>
    </h3>
    <ul class="breadcrumb">
        <li>
            <i class="icon-home"></i>
        ...
        <li><a href="<?php site_url('category/viewCategory'); ?>"><?php echo $this->lang->line("show"); ?> <?php echo $this->lang->line("category"); ?></a></li>
    </ul>
    ...
    <div class="span12">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption"><i class="icon-asterisk"></i><?php echo $this->lang->line("show"); ?> <?php echo $this->lang->line("category"); ?></div>
                <div class="tools">
                        ...
                        if (isset($category)) {
                            foreach ($category as $cat) {
                                ...
                                <tr >
                                    ...
                                    <td><img src = "<?php echo base_url() . 'images/category/thumb' . $cat->image; ?>" ></td>
                                    <td class="center"><?php
                                        if ($cat->status == "1") {
                                            echo "Active";
                                        } else {
                                        ...
                                        ?></td>
                                    <td style="width:70px;">
                                        <a href="<?php echo base_url('category/editCategory'); ?>/<?php echo $cat->id; ?>" ><img src = "<?php echo base_url() . 'images/edit.png' ?>" alt="Edit" height="30" width="30"></a>
                                        <a href="<?php echo base_url('common/isDeleted'); ?>/<?php echo $cat->id; ?>/category/category/viewCategory" ><img src = "<?php echo base_url() . 'images/delete.png' ?>" alt="Delete" height="30" width="30"></a>
                                    </td>
