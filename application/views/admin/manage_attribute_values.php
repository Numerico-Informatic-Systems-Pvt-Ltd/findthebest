            ...
            <div class="portlet-body form">
               <!-- <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                ...
                <div class="control-group attr">
                    <label class="control-label"><?php echo $this->lang->line("attribute"); ?> <span class="required">*</span></label>
                    <div class="controls">
                        <select name="attribute_name" class="span6 m-wrap">
                            <option value="0" seleted><?php echo $this->lang->line("attribute"); ?> </option>
                            <?php
                            foreach ($attribute as $attr) {
                                ?>
                ...
                <div class="control-group">
                    <label class="control-label"><?php echo $this->lang->line("attribute"); ?> <?php echo $this->lang->line("value"); ?><span class="required">*</span></label>
                    <div class="controls">
                        <?php
                        $attributes = array(
                        ...
                        echo form_error('attribute_value', '<span class="req">', '</span>');
                        ?>
                        <span class="help-inline"></span>
                    </div>
                </div>
