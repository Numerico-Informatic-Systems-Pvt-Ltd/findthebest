...
?>
        <div class="alert alert-error">
            ...
            <span><?php echo $this->lang->line("invalid_email"); ?></span>
        </div>
<?php 
	} 
?>
		...
		<form class="form-vertical login-form" action=" " method="post">
			<h3 class="form-title"><?php echo $this->lang->line("login_account"); ?></h3>
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-user"></i>
						<input class="m-wrap placeholder-no-fix" type="text" autocomplete="off" placeholder="<?php echo $this->lang->line("username"); ?>" name="username"/>
					</div>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-lock"></i>
						<input class="m-wrap placeholder-no-fix" type="password" autocomplete="off" placeholder="<?php echo $this->lang->line("password"); ?>" name="password"/>
					</div>
				</div>
			</div>
			<div class="form-actions">
				<label class="checkbox">
				<input type="checkbox" name="remember" value="1"/> <?php echo $this->lang->line("remember_me"); ?>
				</label>
				<button type="submit" class="btn green pull-right">
				<?php echo $this->lang->line("login"); ?> <i class="m-icon-swapright m-icon-white"></i>
				</button>            
			</div>
			<div class="forget-password">
				<h4><?php echo $this->lang->line("forgot_password"); ?>?</h4>
				<p>
					<?php echo $this->lang->line("no_worries"); ?>no worries, click <a href="<?php echo base_url('login/forgetPassword'); ?>"  id="forget-password"><?php echo $this->lang->line("here"); ?></a>
					<?php echo $this->lang->line("to_reset_password"); ?>
				</p>
			</div>
		</form>
		<!-- END LOGIN FORM -->        
		...
		<form class="form-vertical forget-form" action="index.html" method="post">
			...
			<p><?php echo $this->lang->line("enter_email_password"); ?></p>
			<div class="control-group">
				<div class="controls">
					<div class="input-icon left">
			...
			<div class="form-actions">
				...
				<i class="m-icon-swapleft"></i> <?php echo $this->lang->line("back"); ?>
				</button>
				<button type="submit" class="btn green pull-right">
